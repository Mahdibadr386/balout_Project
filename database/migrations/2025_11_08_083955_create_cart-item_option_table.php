...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('cart_item_options', function (Blueprint $table) {
            ...
            $table->foreignId('option_detail_id')->nullable()->constrained('option_details')->cascadeOnDelete();
            $table->foreignId('option_message_id')->nullable()->constrained('option_messages')->cascadeOnDelete();
